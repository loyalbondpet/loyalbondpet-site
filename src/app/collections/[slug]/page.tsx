...
export async function generateMetadata({ params }: CollectionPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: collection.description,
      url: `https://www.loyalbondpet.com/collections/${slug}`,
      type: 'website',
    },
  };
}
...
export default async function CollectionPage({ params }: CollectionPageProps) {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Collections', item: 'https://www.loyalbondpet.com/collections' },
      { '@type': 'ListItem', position: 3, name: collection.name, item: `https://www.loyalbondpet.com/collections/${slug}` },
    ],
  };
