    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      ...
      <div className="prose prose-lg max-w-none text-brand-gray space-y-6">
        ...
        <section>
          ...
          <p>Need a different size or color? We&apos;re happy to help! Contact us at <strong className="text-brand-dark">sales@loyalbondpet.com</strong> and we&apos;ll arrange an exchange. Exchange shipping is free within the contiguous United States.</p>
        </section>
