...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  const faqList: Array<{ q: string; a: string }> = product.slug === 'lift-assist-harness' ? [
    ...
    { q: 'How does elevation help my dog\'s neck?', a: 'The raised stand positions the bowl at a comfortable height that reduces neck strain and promotes natural eating posture. This is especially important for senior dogs with neck stiffness, large breeds, and dogs with limited mobility.' },
