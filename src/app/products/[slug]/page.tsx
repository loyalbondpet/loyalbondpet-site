...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  const faqList: Array<{ q: string; a: string }> = product.slug === 'lift-assist-harness' ? [
    ...
    { q: 'Can these socks help with sensitive paws?', a: 'Yes. The soft fabric helps protect paws from everyday licking and scratching, while the anti-slip grips provide confident footing on smooth floors. Many customers use them for senior dogs and dogs with limited mobility who need extra traction at home.' },
    ...
    { q: 'How do I adjust the height?', a: 'The feeder offers five height settings — 8.5, 16, 23, 31, and 34.5 cm (3.3 to 13.6 inches). Simply adjust the foldable legs to the desired level. This covers small puppies, medium breeds, and large or senior dogs that benefit from a raised dining position.' },
    { q: 'What are the two bowls for?', a: 'Each set includes two removable stainless steel bowls: one with a maze-pattern slow feeder that encourages paced eating for better digestive comfort, and one open bowl for water or regular food. Both bowls lift out for easy cleaning.' },
    { q: 'Is it easy to store and transport?', a: 'Yes. The ABS frame folds flat when not in use, making it compact for storage or travel. The entire unit weighs 1.25 kg (2.76 lb) and the trapezoidal base with non-slip pads keeps it stable on any floor surface.' },
    { q: 'What colors are available?', a: 'The elevated feeder comes in Black and Grey. Both options feature the same durable ABS frame and stainless steel bowls.' },
  ...
  ] : product.slug === 'anti-choke-slow-feeder-bowl' ? [
    { q: 'How does the slow feeder bowl work?', a: 'The interior features a central raised dome surrounded by fin-shaped barriers and rounded nodules. This maze pattern forces your pet to navigate around obstacles to reach kibble, naturally slowing down eating and extending mealtime from about 5 minutes to around 20 minutes.' },
    { q: 'Is this bowl suitable for both dogs and cats?', a: 'Yes. The bowl is designed for both dogs and cats, especially fast eaters. Its one-size design works well for small to medium dog breeds and most cats. The wide mouth makes it easy for flat-faced and short-snouted pets to eat comfortably.' },
    { q: 'What material is the bowl made of? Is it safe?', a: 'The bowl is made of BPA-free, food-safe plastic. It is durable, smooth, non-toxic, and free of harmful chemicals. The material is easy to clean and designed for daily use.' },
    { q: 'Will the bowl slide or tip over while my pet eats?', a: 'No. The wide star-shaped five-point base provides excellent stability on tile, hardwood, laminate, and other smooth surfaces. The non-slip design keeps the bowl firmly in place even during enthusiastic meals.' },
    { q: 'How do I clean the bowl?', a: 'Simply rinse with warm water and mild soap, or wipe clean with a damp cloth after each meal. The smooth, non-porous surface resists food buildup and dries quickly. It is also top-rack dishwasher safe.' },
    { q: 'Does slower eating really help with digestion?', a: 'Yes. Eating too quickly can cause choking, gagging, regurgitation, bloating, and even GDV (gastric dilatation-volvulus) in deep-chested breeds. By slowing the pace, the bowl promotes better chewing, healthier digestion, and can help with weight management by giving your pet time to feel full.' },
