...
Available in White or Blue. One size fits all.`,
    ...
    colors: ['White', 'Blue'],
    sizeVariants: [
      { label: 'One Size', dimensions: '18 x 4.5 cm (Tip: 3 cm)', weight: '50 g (with packaging)', price: 6.99 }
    ],
    features: [
  ...
  },
  {
    ...
    specifications: {
      ...
      'Shape': 'Paw print',
      'Dimensions': 'Approx. 15 × 15 × 1.5 cm (5.9 × 5.9 × 0.6 in)',
      'Weight': 'Approx. 60 g (2.1 oz)',
      'Colors': 'Purple, Coral Orange',
      'Suction Cups': '2 integrated clear suction cups',
      'Temperature Range': '-40°C to +230°C (-40°F to +446°F)',
      'Care': 'Top-rack dishwasher safe',
      'Packaging': 'OPP bag',
      'MOQ': '2 pieces (mixed colors)',
    },
    wholesaleInfo: {
  ...
  },
  {
    ...
    specifications: {
      'Material': 'Breathable mesh + nylon webbing + plastic buckles',
      'Color': 'Beige/Orange (single color option)',
      'Sizes': 'S / M / L / XL',
      'Handle': 'Padded white mesh top handle',
      'Closure': 'Quick-release plastic buckles',
      'Care': 'Hand wash, air dry',
      'Packaging': 'OPP bag',
      'MOQ': '2 pieces (mixed sizes)',
      'Carton': '100 pcs/carton (factory standard)',
    },
    wholesaleInfo: {
