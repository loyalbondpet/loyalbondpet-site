...
Available in White or Blue. One size fits all.`,
  ...
  {
    id: '31',
    slug: 'silicone-lick-mat',
    name: 'Paw-Shaped Silicone Lick Mat with Suction Cups',
    price: 8.99,
    compareAtPrice: 12.99,
    priceRange: '$8.99',
    description: 'Keep your senior dog calm and entertained during bath time, grooming, or nail trimming with our paw-shaped silicone lick mat. Made from food-grade, BPA-free silicone, it features multiple textured zones that slow down fast eaters and promote mental enrichment. The strong integrated suction cups securely attach to any smooth surface — bathtub walls, shower tiles, glass, or countertops. Simply spread peanut butter, yogurt, pumpkin puree, or wet food across the textured surface and let your dog lick away stress. Top-rack dishwasher safe for effortless cleanup. Available in Purple and Coral Orange.',
    shortDescription: 'Food-grade silicone lick mat with suction cups — calms anxious dogs during baths, grooming & nail trims while slowing down fast eaters.',
    collection: 'Grooming & Bath',
    collectionSlug: 'grooming-bath',
    images: [
      '/images/products/silicone-lick-mat/main.jpg',
      '/images/products/silicone-lick-mat/g1.jpg',
      '/images/products/silicone-lick-mat/g2.jpg',
    ],
    rating: 4.5,
    reviewCount: 0,
    badge: 'New',
    colors: ['Purple', 'Coral Orange'],
    features: [
      'Food-grade, BPA-free silicone — safe for all dogs',
      'Paw-print shape with 5 textured zones for slow feeding',
      'Strong integrated suction cups grip any smooth surface',
      'Calms anxiety during baths, grooming & nail trims',
      'Promotes dental health through licking action',
      'Dishwasher safe (top rack) for easy cleaning',
      'Freezer safe — fill with yogurt or pumpkin for a frozen treat',
      'Heat resistant from -40°F to +446°F (-40°C to +230°C)',
    ],
    specifications: [
      { label: 'Material', value: 'Food-grade silicone (BPA-free)' },
      { label: 'Shape', value: 'Paw print' },
      { label: 'Dimensions', value: 'Approx. 15 × 15 × 1.5 cm (5.9 × 5.9 × 0.6 in)' },
      { label: 'Weight', value: 'Approx. 60 g (2.1 oz)' },
      { label: 'Colors', value: 'Purple, Coral Orange' },
      { label: 'Suction Cups', value: '2 integrated clear suction cups' },
      { label: 'Temperature Range', value: '-40°C to +230°C (-40°F to +446°F)' },
      { label: 'Care', value: 'Top-rack dishwasher safe' },
      { label: 'Packaging', value: 'OPP bag' },
      { label: 'MOQ', value: '2 pieces (mixed colors)' },
    ],
    wholesaleInfo: {
      moq: '2 pcs (mixed colors)',
  ...
  },,
  {
    ...
    name: 'Portable Hind Leg Support Belt for Senior Dogs',
    price: 14.99,
    compareAtPrice: 19.99,
    priceRange: '$13.99 - $18.99',
    description: 'A lightweight, portable support belt designed to help senior dogs with weak hind legs stand up, climb stairs, get in and out of vehicles, and navigate daily mobility challenges. The breathable beige mesh body panel is soft against your dog\'s belly while the padded white mesh handle provides a comfortable grip for you. Bright orange nylon webbing straps with heavy-duty black quick-release buckles make it easy to put on and take off. Fully adjustable at both the waist and support straps for a secure, custom fit. When not in use, simply fold it flat and tuck it into a bag — much more compact than a full support harness. Ideal for arthritis, hip dysplasia, post-surgery recovery (ACL/CCL/TPLO), IVDD, and general age-related mobility decline.',
    shortDescription: 'Lightweight portable hind leg lift belt — helps senior & recovering dogs with stairs, cars & standing. Breathable mesh, padded handle, adjustable fit.',
    collection: 'Travel & Car',
    collectionSlug: 'travel-car',
    images: [
      '/images/products/hind-leg-support-belt/main.jpg',
      '/images/products/hind-leg-support-belt/g1.jpg',
      '/images/products/hind-leg-support-belt/g2.jpg',
    ],
    rating: 4.4,
    reviewCount: 0,
    badge: 'New',
    sizes: ['S', 'M', 'L', 'XL'],
    sizeVariants: [
      { label: 'S', dimensions: 'Waist 28-36 cm / Leg 17 cm (11-14 in / 6.7 in)', weight: '85 g', price: 13.99 },
      { label: 'M', dimensions: 'Waist 35-45 cm / Leg 24 cm (14-18 in / 9.4 in)', weight: '105 g', price: 14.99 },
      { label: 'L', dimensions: 'Waist 42-54 cm / Leg 27 cm (17-21 in / 10.6 in)', weight: '125 g', price: 16.99 },
      { label: 'XL', dimensions: 'Waist 48-60 cm / Leg 31 cm (19-24 in / 12.2 in)', weight: '150 g', price: 18.99 },
    ],
    features: [
      'Lightweight & portable — folds flat for travel or storage',
      'Breathable beige mesh body panel for all-day comfort',
      'Padded white mesh handle protects your hand during lifts',
      'Heavy-duty black quick-release buckles for easy on/off',
      'Bright orange adjustable nylon webbing straps',
      'Fully adjustable waist and support straps for a custom fit',
      'Helps with stairs, cars, standing, walking & post-surgery recovery',
      'Does not interfere with bathroom breaks',
      'Machine washable (hand wash recommended, air dry)',
    ],
    specifications: [
      { label: 'Material', value: 'Breathable mesh + nylon webbing + plastic buckles' },
      { label: 'Color', value: 'Beige/Orange (single color option)' },
      { label: 'Sizes', value: 'S / M / L / XL' },
      { label: 'Handle', value: 'Padded white mesh top handle' },
      { label: 'Closure', value: 'Quick-release plastic buckles' },
      { label: 'Care', value: 'Hand wash, air dry' },
      { label: 'Packaging', value: 'OPP bag' },
      { label: 'MOQ', value: '2 pieces (mixed sizes)' },
      { label: 'Carton', value: '100 pcs/carton (factory standard)' },
    ],
    wholesaleInfo: {
      moq: '2 pcs (mixed sizes)',
      leadTime: '2-5 business days',
      payment: 'T/T 50% deposit, 50% before shipment',
      shipping: 'FOB Ningbo/Shanghai',
...
export const crossSellMap: Record<string, string[]> = {
  ...
  'hind-leg-support-harness': ['mesh-support-sling', 'hind-leg-support-belt', 'inflatable-dog-recovery-collar', 'orthopedic-bolster-dog-bed'],
  'mesh-support-sling': ['hind-leg-support-harness', 'hind-leg-support-belt', 'inflatable-dog-recovery-collar', 'orthopedic-bolster-dog-bed'],
  ...
  'pet-paw-cleaner-cup': ['waterproof-silicone-dog-rain-boots', 'orthopedic-bolster-dog-bed', 'silicone-lick-mat'],
  ...
  'side-grip-pet-pill-dispenser': ['inflatable-dog-recovery-collar', 'non-woven-dog-recovery-collar', 'hind-leg-support-harness', 'mesh-support-sling', 'hind-leg-support-belt'],
  // Grooming / bathing / enrichment group
  'silicone-lick-mat': ['pet-paw-cleaner-cup', 'anti-choke-slow-feeder-bowl', 'side-grip-pet-pill-dispenser'],
  // Mobility support belt - entry level
  'hind-leg-support-belt': ['hind-leg-support-harness', 'mesh-support-sling', 'inflatable-dog-recovery-collar', 'orthopedic-bolster-dog-bed'],
};
