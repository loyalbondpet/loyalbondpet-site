...
export default function ProductCard({ product }: ProductCardProps) {
  return (
    ...
    >
      {/* Image placeholder */}
      <div className="aspect-square bg-gradient-to-br from-brand-beige to-brand-beige/50 relative overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <svg className="w-16 h-16 text-brand-green/30 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          <span className="text-xl font-bold text-brand-green">${product.price.toFixed(2)}</span>
          <button
