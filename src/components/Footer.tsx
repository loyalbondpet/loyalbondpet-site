          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <span className="block text-xs text-gray-400 -mt-0.5">恒伴 — Loyal companionship for every stage of life</span>
              </div>
            </Link>
            <p className="text-gray-400 text-sm mb-6 max-w-sm">
              Starting with senior dog functional products and expanding to one-stop pet supplies including exotic pets. Every product designed with love, safety, and quality.
            </p>
            {/* Social links */}
